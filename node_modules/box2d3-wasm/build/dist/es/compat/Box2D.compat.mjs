...
var ___getTypeName, _malloc, _free, _emscripten_stack_get_end, _emscripten_stack_get_base, __emscripten_timeout, _emscripten_stack_init, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, ___set_stack_limits, memory, __indirect_function_table, wasmMemory, wasmTable;
...
function assignWasmExports(wasmExports) {
  ...
  __emscripten_timeout = wasmExports["Z"];
  _emscripten_stack_init = wasmExports["_"];
...
var wasmImports = {
  ...
  /** @export */ n: __embind_register_value_object_field,
  /** @export */ O: __embind_register_void,
  /** @export */ F: __emscripten_runtime_keepalive_clear,
  /** @export */ i: __emval_create_invoker,
  /** @export */ e: __emval_decref,
  /** @export */ w: __emval_get_global,
  /** @export */ m: __emval_get_property,
  /** @export */ k: __emval_incref,
  /** @export */ K: __emval_instanceof,
  /** @export */ h: __emval_invoke,
  /** @export */ q: __emval_new_array,
  /** @export */ l: __emval_new_cstring,
  /** @export */ P: __emval_new_object,
  /** @export */ g: __emval_run_destructors,
  /** @export */ v: __emval_set_property,
  /** @export */ G: __setitimer_js,
  /** @export */ J: _clock_time_get,
