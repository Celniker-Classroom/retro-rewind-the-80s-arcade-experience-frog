...
export interface b2JointEvent extends ClassHandle {
  jointId: b2JointId;
}

export interface b2JointEvents extends ClassHandle {
  count: number;
  GetJointEvent(_0: number): b2JointEvent;
}
...
export interface b2MotionLocks extends ClassHandle {
  linearX: boolean;
  linearY: boolean;
  angularZ: boolean;
}
...
export type b2JointType = b2JointTypeValue<0>|b2JointTypeValue<2>|b2JointTypeValue<1>|b2JointTypeValue<3>|b2JointTypeValue<4>|b2JointTypeValue<5>|b2JointTypeValue<6>;
...
export interface BasicJointInterface extends ClassHandle {
  ...
  SetForceThreshold(_0: number): void;
  GetForceThreshold(): number;
  SetTorqueThreshold(_0: number): void;
  GetTorqueThreshold(): number;
}

export interface b2JointDef extends ClassHandle {
...
export interface BasicMotorJointInterface extends ClassHandle {
  ...
  SetMaxSpringForce(_0: number): void;
  GetMaxSpringForce(): number;
  SetMaxSpringTorque(_0: number): void;
  GetMaxSpringTorque(): number;
  SetMaxVelocityForce(_0: number): void;
  GetMaxVelocityForce(): number;
  SetMaxVelocityTorque(_0: number): void;
...
interface EmbindModule {
  ...
  b2JointType: {b2_distanceJoint: b2JointTypeValue<0>, b2_motorJoint: b2JointTypeValue<2>, b2_filterJoint: b2JointTypeValue<1>, b2_prismaticJoint: b2JointTypeValue<3>, b2_revoluteJoint: b2JointTypeValue<4>, b2_weldJoint: b2JointTypeValue<5>, b2_wheelJoint: b2JointTypeValue<6>};
  BodyRef: {};
  BodyConstRef: {};
  ChainRef: {};
  ChainConstRef: {};
  ...
  b2Shape_SetSurfaceMaterial(_0: b2ShapeId, _1: b2SurfaceMaterial | null): void;
  ...
  b2Shape_ApplyWind(_0: b2ShapeId, _1: b2Vec2, _2: number, _3: number, _4: boolean): void;
